                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="contact-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                            <p></p>
                            <ul class="address">
                                <li><i class="fa fa-map-marker"></i> <span> Direccion:</span> --- </li>
                                <li><i class="fa fa-phone"></i> <span> Teléfono:</span> 364-511324  </li>
                                <li><i class="fa fa-envelope"></i> <span> Email:</span><a href="mailto:someone@yoursite.com"> direccion de correo</a></li>
                                <li><i class="fa fa-globe"></i> <span> Web:</span> <a href="#">www.laautentica.com.ar</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
